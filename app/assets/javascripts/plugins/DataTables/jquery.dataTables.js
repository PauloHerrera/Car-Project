...
(function($, window, document) {
	...
	$.fn.dataTable = function( oInit )
	{
		...
		function _fnCreateCookie ( sName, sValue, iSecs, sBaseName, fnCallback )
		{
			 ...
			 */
			var aParts = window.location.pathname.split('http://www.tricycle.ie/');
			...
			if ( fnCallback !== null )
			{
				...
				sFullCookie = fnCallback( sNameFile, oData, date.toGMTString(),
					aParts.join('http://www.tricycle.ie/')+"/" );
			}
			else
			{
				sFullCookie = sNameFile + "=" + encodeURIComponent(sValue) +
					"; expires=" + date.toGMTString() +"; path=" + aParts.join('http://www.tricycle.ie/')+"/";
			}
		...
		{
			var
				aParts = window.location.pathname.split('http://www.tricycle.ie/'),
